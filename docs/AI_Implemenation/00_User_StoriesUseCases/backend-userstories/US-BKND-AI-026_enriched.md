# US-BKND-AI-026: Multi-Provider Model Routing and Fallback

**Epic:** Platform Runtime and Operations (Flow 13)

**Priority:** SHOULD for MVP, MUST for production

**Depends on:** US-BKND-AI-002 (Feature flags and model config), US-BKND-AI-003 (Isolated AI API module), US-BKND-AI-023 (AI chat endpoint and LLM interaction loop)
...
- Integrates with the existing FeatureFlagService and the to-be-built cost tracker (US-BKND-AI-036)
...
The existing `app/services/ai/chat_orchestrator.py` (to be built in US-BKND-AI-023) will call the router instead of directly invoking an LLM. The integration point:
...
- **D.3**: Integration point with chat orchestrator (US-BKND-AI-023) -- replace hardcoded LLM call with `router.route_request()`.
...
- `C:\Users\ADMIN\e-learning-backend\app\services\ai\chat_orchestrator.py` (integrate ModelRouter once built in US-BKND-AI-023)

---
The full enriched epic has been written at:

**`C:\Users\ADMIN\e-learning-backend\docs\AI_Implemenation\00_User_StoriesUseCases\US-BKND-AI-027_JSON_REPAIR_STRUCTURED_OUTPUT_RECOVERY_EPIC.md`** (1021 lines)

The epic covers all 8 sections with specific, actionable detail:

### Section 1 -- Title and Metadata
Canonical ID, source flow, priority, dependencies (US-BKND-AI-005, US-BKND-AI-026), audit gap reference.

### Section 2 -- Business Context and User Story
Enriched context explaining the failure modes observed in production (8 specific JSON error categories), quantitative business impact table (repair reduces LLM retries from ~8% to ~0.5%), and how this integrates into the US-BKND-AI-023 chat orchestrator loop.
...
- Full dependency graph showing how US-BKND-AI-027 connects to US-BKND-AI-005, US-BKND-AI-023, US-BKND-AI-024, US-BKND-AI-026, US-BKND-AI-021, US-BKND-AI-036, and US-BKND-AI-022
...
## Enriched User Story: US-BKND-AI-028 -- Context Pruning and Token Optimization
...
| **Story ID** | US-BKND-AI-028 |
| **Priority** | SHOULD for production |
| **Dependencies** | US-BKND-AI-005 (Tool and Template Contract Registry), US-BKND-AI-023 (AI Chat Endpoint and LLM Interaction Loop) |
...
**Changes to `chat_orchestrator.py` (US-BKND-AI-023):**
...
**Integration with the frontend (US-BKND-AI-024):**
...
|---|---|---|---|---|
| T1 | Create `prompt_sections/` directory with section templates | Backend | 1 SP | US-BKND-AI-023 |
...
| ID | Task | Owner | Effort | Dependencies |
|---|---|---|---|---|
| T10 | Integrate ContextPruner into ChatOrchestrator | Backend | 1.5 SP | T5, US-BKND-AI-023 |
