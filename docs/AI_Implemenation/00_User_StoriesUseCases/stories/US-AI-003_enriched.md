...
**Depends On:** US-AI-002 (feature flags), US-AI-PR01 through US-AI-PR05 (mock auth/authz/tenant/session/user)
**Unlocks:** US-AI-004 (persistence), US-AI-005 (tool contracts), all AI route stories
...
| T3 | Create `app/routers/ai_config.py` with feature-status endpoint | Backend | 1h | US-AI-002 |
...
| T7 | Modify `app/main.py` for conditional AI router mounting | Backend | 2h | T2-T6, US-AI-002 |
